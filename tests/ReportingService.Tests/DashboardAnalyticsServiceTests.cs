...
namespace ReportingService.Tests
{
    public class DashboardAnalyticsServiceTests
    {
        ...
        public async Task GetTenantDashboardOverviewAsync_ReturnsCorrectData()
        {
            ...
            // Set override for tenant filtering
        ...
        {
            // Arrange - bypass all tenant filters for system admin (system admin has Guid.Empty tenant ID)
            var originalOverride = ApplicationDbContext.OverrideTenantId;
            ApplicationDbContext.OverrideTenantId = Guid.Empty;
            ...
            try
            {
                ...
                // Add test data to database (ignore filters for system admin)
                _dbContext.ServiceCategories.Add(category);
            ...
            finally
            {
                ...
                ApplicationDbContext.OverrideTenantId = originalOverride;
            }
        }
    }
}