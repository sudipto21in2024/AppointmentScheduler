...
{
    public class SlotUpdateTests : IDisposable
    {
        ...
        public async Task UpdateSlotAsync_ValidRequest_UpdatesSlot()
        {
            ...
            await _dbContext.SaveChangesAsync(); // Ensure service is saved
        ...
        public async Task UpdateSlotAsync_UnauthorizedUser_ThrowsUnauthorizedAccessException()
        {
            ...
            await _dbContext.SaveChangesAsync(); // Ensure customer is saved
